...
<body>
                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="<?= base_url() ?>album.html">Albums</a></li>
                                        <li><a href="#">blog <i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                <li><a href="<?= base_url() ?>blog.html">blog</a></li>
                                                <li><a href="<?= base_url() ?>single-blog.html">single-blog</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="<?= base_url() ?>#">pages <i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                 <li><a href="<?= base_url() ?>elements.html">elements</a></li>
                                            </ul>
                                        </li>
                ...
                <div class="col-xl-9 col-md-9">
                    <div class="section_title text-center">
                        ...
                        <div class="singnature_thumb">
                            <img src="<?= base_url() ?>img/photography/signature.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row no-gutters align-items-center ">
                <div class="col-lg-6">
                    <div class="wildlife_photo">
                        <img <?= base_url() ?>="img/photography/zebra.png" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row no-gutters ">
                <div class="col-xl-4 col-md-4">
                    <div class="single_photography">
                        <div class="thumb">
                            <img src="<?= base_url() ?>img/gallery/1.png" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_photography">
                        <div class="thumb">
                            <img src="<?= base_url() ?>img/gallery/2.png" alt="">
                        </div>
                        <a  href="baby_gallery.html" class="hover ">
                            <div class="hover_inner">
                                <h3>Baby album</h3>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_photography">
                        <div class="thumb">
                            <img src="<?= base_url() ?>img/gallery/3.png" alt="">
                        </div>
                        <a  href="baby_gallery.html" class="hover ">
                            <div class="hover_inner">
                                <h3>Baby album</h3>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_photography">
                        <div class="thumb">
                            <img src="<?= base_url() ?>img/gallery/4.png" alt="">
                        </div>
                        <a  href="baby_gallery.html" class="hover ">
                            <div class="hover_inner">
                                <h3>Baby album</h3>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_photography">
                        <div class="thumb">
                            <img src="<?= base_url() ?>img/gallery/5.png" alt="">
                        </div>
                        <a  href="baby_gallery.html" class="hover ">
                            <div class="hover_inner">
                                <h3>Baby album</h3>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_photography">
                        <div class="thumb">
                            <img src="<?= base_url() ?>img/gallery/6.png" alt="">
                        </div>
                        <a  href="baby_gallery.html" class="hover ">
                            <div class="hover_inner">
                                <h3>Baby album</h3>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_photography">
                        <div class="thumb">
                            <img src="<?= base_url() ?>img/gallery/7.png" alt="">
                        </div>
                        <a  href="baby_gallery.html" class="hover ">
                            <div class="hover_inner">
                                <h3>Baby album</h3>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_photography">
                        <div class="thumb">
                            <img src="<?= base_url() ?>img/gallery/8.png" alt="">
                        </div>
                        <a  href="baby_gallery.html" class="hover ">
                            <div class="hover_inner">
                                <h3>Baby album</h3>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_photography">
                        <div class="thumb">
                            <img src="<?= base_url() ?>img/gallery/9.png" alt="">
                        </div>
                        <a  href="baby_gallery.html" class="hover ">
                            <div class="hover_inner">
                                <h3>Baby album</h3>
                    ...
                    <div class="testimonial_active owl-carousel">
                        <div class="single_testmonial text-center">
                            ...
                            <div class="author_name d-flex align-items-center justify-content-center">
                                <div class="thumb">
                                    <img src="<?= base_url() ?>img/testmonial/author.png" alt="">
                                </div>
    ...
    <div class="instragram_area">
        <div class="single_instagram">
            <img src="<?= base_url() ?>img/instragram/1.png" alt="">
            <div class="ovrelay">
                <a href="#">
                    <i class="fa fa-instagram"></i>
                </a>
        ...
        <div class="single_instagram">
            <img src="<?= base_url() ?>img/instragram/2.png" alt="">
            <div class="ovrelay">
                <a href="#">
                    <i class="fa fa-instagram"></i>
                </a>
        ...
        <div class="single_instagram">
            <img src="<?= base_url() ?>img/instragram/3.png" alt="">
            <div class="ovrelay">
                <a href="#">
                    <i class="fa fa-instagram"></i>
                </a>
        ...
        <div class="single_instagram">
            <img src="<?= base_url() ?>img/instragram/4.png" alt="">
            <div class="ovrelay">
                <a href="#">
                    <i class="fa fa-instagram"></i>
                </a>
        ...
        <div class="single_instagram">
            <img src="<?= base_url() ?>img/instragram/5.png" alt="">
            <div class="ovrelay">
                <a href="#">
                    <i class="fa fa-instagram"></i>
                </a>
        ...
        <div class="single_instagram">
            <img src="<?= base_url() ?>img/instragram/6.png" alt="">
            <div class="ovrelay">
                <a href="#">
                    <i class="fa fa-instagram"></i>
                </a>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <script src="<?= base_url() ?>/wow.min.js"></script>
