        ...
        <div class="row w-100">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <form class="pt-3" action="<?= base_url('index.php/Login_pelanggan/Login')?>" method="post">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-sample" action="<?=base_url('index.php/Login_pelanggan/register')?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
